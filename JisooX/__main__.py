...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/Randi356/ghoundz-robot)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/Randi356/ghoundz-robot.git)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/06706c06e891aec664787.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="[► Help ◄]",callback_data="help_back"),InlineKeyboardButton(text="[► Creator ◄]",url="https://t.me/black_snipers")]]
    keyboard += [[InlineKeyboardButton(text="[► Source ◄]",url="https://github.com/Randi356/ghoundz-robot"),InlineKeyboardButton(text="[► Add Me ◄]",url="t.me/{}?startgroup=true".format(bot.username))]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="[► Creator ◄]",url="https://t.me/black_snipers")]]))
        return
